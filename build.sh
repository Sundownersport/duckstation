...
set(GCC_CROSS_DIR "/usr/lib/gcc-cross/aarch64-linux-gnu/9")
set(CMAKE_C_FLAGS_INIT "-I/usr/aarch64-linux-gnu/include")
set(CMAKE_CXX_FLAGS_INIT "-stdlib=libc++ -I/usr/aarch64-linux-gnu/include")
set(CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld -stdlib=libc++ -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu -lc++abi")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld -stdlib=libc++ -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld -stdlib=libc++ -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu")
