...
set(GCC_CROSS_DIR "/usr/lib/gcc-cross/aarch64-linux-gnu/10")
set(CMAKE_C_FLAGS_INIT "-I/usr/aarch64-linux-gnu/include")
set(CMAKE_CXX_FLAGS_INIT "-I/usr/aarch64-linux-gnu/include -I${GCC_CROSS_DIR}/../../../../aarch64-linux-gnu/include/c++/10 -I${GCC_CROSS_DIR}/../../../../aarch64-linux-gnu/include/c++/10/aarch64-linux-gnu")
set(CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld -B${GCC_CROSS_DIR} -L${GCC_CROSS_DIR} -L/usr/aarch64-linux-gnu/lib -L/usr/lib/aarch64-linux-gnu")
