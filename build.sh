...
set(CMAKE_C_FLAGS_INIT "--gcc-toolchain=/usr -I/usr/aarch64-linux-gnu/include")
set(CMAKE_CXX_FLAGS_INIT "--gcc-toolchain=/usr -I/usr/aarch64-linux-gnu/include")
set(CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld --gcc-toolchain=/usr")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld --gcc-toolchain=/usr")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld --gcc-toolchain=/usr")
