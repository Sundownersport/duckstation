...
set(GCC_VER "12")
set(GCC_CROSS_DIR "/usr/lib/gcc-cross/aarch64-linux-gnu/${GCC_VER}")
set(GCC_INCLUDE "/usr/aarch64-linux-gnu/include/c++/${GCC_VER}")
set(CMAKE_C_FLAGS_INIT "-I/usr/aarch64-linux-gnu/include")
set(CMAKE_CXX_FLAGS_INIT "-I/usr/aarch64-linux-gnu/include -I${GCC_INCLUDE} -I${GCC_INCLUDE}/aarch64-linux-gnu")
