...
set(CMAKE_EXE_LINKER_FLAGS_INIT "-fuse-ld=lld -B/usr/lib/gcc-cross/aarch64-linux-gnu/9 -L/usr/lib/gcc-cross/aarch64-linux-gnu/9")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld -B/usr/lib/gcc-cross/aarch64-linux-gnu/9 -L/usr/lib/gcc-cross/aarch64-linux-gnu/9")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld -B/usr/lib/gcc-cross/aarch64-linux-gnu/9 -L/usr/lib/gcc-cross/aarch64-linux-gnu/9")
